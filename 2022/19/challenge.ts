...
class State {
  ...
  constructor(robots: number[], materials: number[], timeLeft: number) {
    this.robots = robots;
...
function simulateBlueprint(blueprint: Blueprint, startTime: number): number {
